...
model_co10 = np.load(sou_model+'flux_'+model+'_co10.npy') #* ew_corr_co10    
model_co21 = np.load(sou_model+'flux_'+model+'_co21.npy') #* ew_corr_co21  
model_13co21 = np.load(sou_model+'flux_'+model+'_13co21.npy') #* ew_corr_13co21 
model_13co32 = np.load(sou_model+'flux_'+model+'_13co32.npy') #* ew_corr_13co32 
model_c18o21 = np.load(sou_model+'flux_'+model+'_c18o21.npy') #* ew_corr_c18o21 
model_c18o32 = np.load(sou_model+'flux_'+model+'_c18o32.npy') #* ew_corr_c18o32 
...
noise_co10 = fits.open(sou_data+'errors/'+source+'_CO10_emom0_broad_nyq.fits')[0].data[idx_y,idx_x]
noise_co21 = fits.open(sou_data+'errors/'+source+'_CO21_emom0_broad_nyq.fits')[0].data[idx_y,idx_x]
noise_13co21 = fits.open(sou_data+'errors/'+source+'_13CO21_emom0_broad_nyq.fits')[0].data[idx_y,idx_x]
noise_13co32 = fits.open(sou_data+'errors/'+source+'_13CO32_emom0_broad_nyq.fits')[0].data[idx_y,idx_x]
noise_c18o21 = fits.open(sou_data+'errors/'+source+'_C18O21_emom0_broad_nyq.fits')[0].data[idx_y,idx_x]
noise_c18o32 = fits.open(sou_data+'errors/'+source+'_C18O32_emom0_broad_nyq.fits')[0].data[idx_y,idx_x]
...
np.save(sou_model+'chi2_'+model+'_ewcor_'+str(idx_x)+'_'+str(idx_y), chi_sum)
...
plt.savefig(sou_model+'flux_'+model+'_rmcor_contours_'+str(idx_x)+'_'+str(idx_y)+'_cal10-20.pdf', bbox_inches='tight', format='pdf')
plt.tight_layout()
plt.show()
