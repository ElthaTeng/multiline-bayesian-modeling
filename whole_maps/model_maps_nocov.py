...
flux_c18o21 = fits.open(sou_data+source+'_C18O21_mom0_broad_nyq.fits')[0].data
flux_c18o32 = fits.open(sou_data+source+'_C18O32_mom0_broad_nyq.fits')[0].data
...
noise_c18o21 = fits.open(sou_data+'errors/'+source+'_C18O21_emom0_broad_nyq.fits')[0].data
noise_c18o32 = fits.open(sou_data+'errors/'+source+'_C18O32_emom0_broad_nyq.fits')[0].data
...
if output_map == 'bestfit':
    ...
    np.save(sou_model+'chi2_'+model+'_rmcor_'+source+'_los200.npy', chi2_map)
    np.save(sou_model+'Nco_'+model+'_rmcor_'+source+'_los200_'+output_map+'.npy', N_co)
    np.save(sou_model+'Tk_'+model+'_rmcor_'+source+'_los200_'+output_map+'.npy', T_k)
    np.save(sou_model+'nH2_'+model+'_rmcor_'+source+'_los200_'+output_map+'.npy', n_h2)
    np.save(sou_model+'X12to13_'+model+'_rmcor_'+source+'_los200_'+output_map+'.npy', X_co213co)
    np.save(sou_model+'X13to18_'+model+'_rmcor_'+source+'_los200_'+output_map+'.npy', X_13co2c18o)
    np.save(sou_model+'phi_'+model+'_rmcor_'+source+'_los200_'+output_map+'.npy', beam_fill)
